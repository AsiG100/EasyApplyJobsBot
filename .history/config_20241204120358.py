...
blackListTitles = [".Net", "C#", "Sales", "Manager", "Node.js", "React", "Embedded", "Staff", "Principal" , "Firmware", "System", "Front" "data engineer"]
...
GlobalLogicExperience = ["1-3 years", "3-5 years"]
...
GlobalLogicLocation = ["Los Angeles", "Remote"]
# Freelance yes or no
GlobalLogicFreelance = ["no"]
# Remote work yes or no
GlobalLogicRemoteWork = ["yes"]
# Optional! Keyword:["javascript", "react", "angular", ""]
GlobalLogicKeyword = ["Python", "AWS"]
# Global Logic Job apply settinngs
FirstName = "Asaf"
LastName = "Goloub"
Email = "asi.g100@gmail.com"
LinkedInProfileURL = "www.linkedin.com/in/asaf-goloub"
Phone = "8189297482" #OPTIONAL
