...
class Linkedin:
    def __init__(self):
            ...
            self.driver = webdriver.Chrome(service=ChromeService(),options=utils.chromeBrowserOptions())
                    ...
                    if "blacklisted" in jobProperties: 
                        ...
                        if easyApplybutton is not False:
                            ...
                            try:
                                ...
                                applied_message = "* 🥵 Too many steps for this job: " if step_counter <= 10 else "* 🥳 Just Applied to this job: "
                                ...
                                try:
                                    self.driver.find_element(By.CSS_SELECTOR,"button[aria-label='Continue to next step'], button[aria-label='Review your application']").click()
                                    time.sleep(random.uniform(1, constants.botSpeed))
                                    self.chooseResume()
